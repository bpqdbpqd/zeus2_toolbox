...
for the science data taken with the zobs command.
"""
...
ARRAY_MAP_PATH = "/data2/share/zeus-2/ref/array_map_excel_alternative_20211101.csv"  # path to the array map file, leave None if you don't want
# to use any array map
OBS_LOG_DIR = "/data2/share/zeus-2/all_apex_2019/apex_logs/obslogs"  # path to the folder containing the APEX html observation log
...
DATA_DIR = "/data2/share/zeus-2/all_apex_2019/20191128/"  # path to the folder containing the data
WRITE_DIR = "/data/bp/workspace/zeus-2/nb/Plck_g244+54"  # path to the folder to save the reduction result like figures
# or tables, leave None if you want to use the current folder

FLAT_HEADER = {"skychop_191128": [(68, 69)]}  # dictionary of the header and beam numbers of the flat field
...
DATA_HEADER = {"plck_191128": [(0, 39)]}  # dictionary of the header and beam numbers of the science data
...
# reduction
REG_INTEREST = {"spat_ran": (0, 2), "spec_ran": (9, 13)}  # the region of interest of the array to plot in the format
# of dictionary, e.g.
